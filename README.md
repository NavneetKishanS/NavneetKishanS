...
I build backend systems, observability tooling, and LLM-powered applications — with a growing focus on healthcare AI, secure data infrastructure, and agentic workflows. I am a curious dev who likes to drive impact by taking things from "works on my laptop" to "runs reliably in production."

I enjoy building under pressure. Hackathons are where I'm most in my element. Outside work, I follow AI/ML research closely and like poking at the assumptions behind current approaches rather than just applying them.
